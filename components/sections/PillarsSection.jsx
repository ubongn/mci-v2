...
import { BookOpen, Code, Hammer, Users, ArrowRight, Goal, Globe } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        ...
        >
          {pillars.map((pillar, index) => (
            ...
            >
              <Card 
                className="group hover:shadow-lg transition-all duration-300 border-0 bg-gray-50 hover:bg-gray-100"
              >
                <CardHeader className="items-center text-center">
                  <motion.div
                    className="p-4 bg-white rounded-full shadow-sm group-hover:shadow-md transition-all"
        ...
        >
          ...
          >
            ...
            >
              ...
              <span className="font-medium text-blue-600">UN Sustainable Development Goals</span>
            </motion.div>
            <h3 className="text-2xl font-bold mb-4">Our Commitment to Global Goals</h3>
            <p className="text-muted-foreground max-w-2xl mx-auto">
